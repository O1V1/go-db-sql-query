...
func main() {
	...
	newClient := Client{
		FIO:      "Новый Клиент Тестович", // укажите ФИО
		Login:    "test_new_client",       // укажите логин
		Birthday: "20240601",              // укажите день рождения
		Email:    "test_new@yandex.test",  // укажите почту
	}
	...
	newLogin := "NovaNova" // укажите новый логин
